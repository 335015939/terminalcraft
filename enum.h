...
enum _EQUIPMENT_IDS {
    EQUIPMENT_NONE=0,EQUIPMENT_WOOD_HEMLET,EQUIPMENT_WOOD_BREASTPLATE=EQUIPMENT_WOOD_HEMLET,EQUIPMENT_SNAKE_SKIN_CLOAK,
};
enum _ENTITY_IDS {
...
enum _ITEM_TYPES{
    ...
    ITEM_TYPE_MAGIC_MIRROR,ITEM_TYPE_EQUIPABLE
};
enum _ITEM_IDS {
    ...
    ITEM_IRON_SWORD,ITEM_WOOD_HELMET,ITEM_SNAKE_SKIN,ITEM_SNAKE_SKIN_CLOAK,ITEM_WOOD_BREASTEPLATE
};
enum _TILE_TYPES{
