...
enum _COLOR_PAIRS {
    ...
    CP_TILE_FURNACE,CP_ITEM_FURNACE,CP_ITEM_COPPER_PICKAXE,CP_ITEM_IRON_PICKAXE,CP_ITEM_LADDER,CP_TILE_LADDER
...
enum _ITEM_IDS {
    ...
    ITEM_FURNACE,ITEM_COPPER_PICKAXE,ITEM_IRON_PICKAXE,ITEM_LADDER
};
enum _TILE_TYPES{
