...
enum _COLOR_PAIRS {
    ...
    CP_TILE_DOOR,CP_TILE_WOOD_WALL,CP_ITEM_WOOD_WALL,CP_ITEM_CHEST,CP_TILE_CHEST,CP_ITEM_MAGIC_MIRROR,CP_ITEM_SILVER,
...
enum _ITEM_IDS {
    ...
    ITEM_MAGIC_MIRROR,ITEM_SILVER,ITEM_GOLD,ITEM_WOOD_SWORD,ITEM_OAK_SAPLING,ITEM_PINE_SAPLING
};
enum _TILE_TYPES{
