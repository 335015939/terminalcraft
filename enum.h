...
enum _COLOR_PAIRS {
    ...
    CP_ITEM_COPPER_ORE,CP_TILE_COPPER_ORE,CP_ITEM_COPPER,CP_ITEM_IRON
};
enum _TILE_IDS {
    TILE_AIR=0,TILE_DIRT,TILE_STONE,TILE_GRASS,TILE_OAK_LEAF,TILE_OAK_TRUNK,TILE_PINE_TRUNK,TILE_PINE_LEAF,TILE_COAL_ORE,
    TILE_IRON_ORE,TILE_SILVER_ORE,TILE_GOLD_ORE,TILE_DIAMOND_ORE,TILE_COPPER_ORE,
};
enum _TREE_TYPE {
...
enum _ITEM_IDS {
    ...
    ITEM_SILVER_ORE,ITEM_GOLD_ORE,ITEM_DIAMOND_ORE,ITEM_COPPER_ORE,ITEM_COPPER,ITEM_IRON
};
enum _TILE_TYPES{
