...
enum _EQUIPMENT_IDS {
    ...
    EQUIPMENT_IRON_HELMET,EQUIPMENT_IRON_BREASTPLATE,EQUIPMENT_IRON_GREAVES,EQUIPMENT_IRON_BOOTS
};
enum _ENTITY_IDS {
...
enum _ITEM_IDS {
    ...
    ITEM_IRON_SWORD,ITEM_WOOD_HELMET,ITEM_SNAKE_SKIN,ITEM_SNAKE_SKIN_CLOAK,ITEM_WOOD_BREASTPLATE,ITEM_COPPER_HELMET,
    ITEM_COPPER_BREASTPLATE,ITEM_COPPER_GREAVES,ITEM_COPPER_BOOTS,ITEM_COIN_COPPER,ITEM_COIN_SILVER,ITEM_COIN_GOLD,
    ITEM_IRON_HELMET,ITEM_IRON_BREASTPLATE,ITEM_IRON_GREAVES,ITEM_IRON_BOOTS,
};
enum _TILE_TYPES{
