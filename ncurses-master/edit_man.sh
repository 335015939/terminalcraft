...
TERMINFO="/workspace/terminalcraft/ncurses/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /workspace/terminalcraft/ncurses-master/man_alias.sed ; then
cat >>/workspace/terminalcraft/ncurses-master/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /workspace/terminalcraft/ncurses-master/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /workspace/terminalcraft/ncurses-master/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /workspace/terminalcraft/ncurses-master/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /workspace/terminalcraft/ncurses-master/man_alias.sed \
		< $i | sed -f /workspace/terminalcraft/ncurses-master/edit_man.sed >$TMP
